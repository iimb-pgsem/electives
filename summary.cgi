...
# $Id: summary.cgi,v 1.1 2006/02/04 19:19:31 a14562 Exp $
...
sub main()
{
    ...
    print "Number of students submitted: $count<br>\n";
    ...
    print "<table>\n";
    foreach $rollno (sort @rollnos) {
      print "<tr><td>$rollno</td><td>$students{$rollno}{'name'}</td></tr>\n";
    }
    print "</table>\n";
